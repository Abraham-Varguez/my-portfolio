...
const Hero = () => {
  const resume = "https://docs.google.com/document/d/1npY8-ELfSQSwjwfoU_PdZyZUKSu5_wq6/edit";
  ...
  return (
    <section className="profile">
      ...
      <div className="text">
        ...
        <p className="text__p2">
         Fullstack Developer in Charlotte, NC
        </p>
        <div className="btn-container">
          <button className="btn btn-1" onClick={handleResume}>
            Resume
          </button>
          <button className="btn btn-2" href="#contact">
            Contact Info
          </button>
        </div>
