import tdm1 from "../../images/tdm-1.png";
import tdm2 from "../../images/tdm-2.png";
import tdm3 from "../../images/tdm-3.png";
import l2p1 from "../../images/l2p-1.png";
import l2p2 from "../../images/l2p-2.png";
import l2p3 from "../../images/l2p-3.png";
import solar1 from "../../images/solar-1.png";
import solar2 from "../../images/solar-2.png";
import solar3 from "../../images/solar-3.png";
...
const projectData = [
  {
    ...
    gitHub: "https://github.com/Abraham-Varguez/gatewayv2",
    images: [tdm3, tdm1, tdm2],
  },
  {
    title: "E-COMMERCE",
    description:
  ...
  },
  {
    title: "Hope Hacks",
    description:
      "Explore my group project dedicated to public wellness—a mock organization website fostering healthy living. Leading the charge on the front end, I meticulously designed the navigation bar, as well as the home and recipe pages. Using SCSS, the site boasts not just style, but also functionality with a JavaScript. The Recipes dynamically unfold from an API based on search keywords—a testament to the seamless integration of design and technology in promoting a healthier lifestyle.",
    link: "https://github.com",
